      ...
      <section className={styles.volunteer} id="volunteer">
        <div className={styles.successContainer}>
          ...
          <p className={styles.successText}>
            We appreciate your support. A member of our team will contact you soon.
          </p>
        </div>
      </section>
    )
      ...
      <div className={styles.container}>
        ...
        <div className={styles.card}>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.inputGroup}>
              <label htmlFor="phone" className={styles.inputLabel}>Phone Number (optional)</label>
              <input
                type="tel"
                id="phone"
            ...
            <div className={styles.inputGroup}>
              <label className={styles.inputLabel}>How would you like to help?</label>
